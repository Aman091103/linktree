    ...
    <html lang="en">
      <body className={lato.className}>
        ...
        <main className="md:flex min-h-screen">
          <label
            htmlFor="navCb"
            className="inline-flex md:hidden ml-8 
              mt-4 p-4 shadow bg-white rounded-md cursor-pointer items-center gap-2"
          >
            <FontAwesomeIcon icon={faBars} />
            <span>Open naviagtion</span>
          </label>
          ...
          <aside
            className="bg-white w-48 p-4 pt-6 shadow fixed 
