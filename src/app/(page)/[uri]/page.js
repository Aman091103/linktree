...
import { faDiscord, faFacebook, faGithub, faInstagram, faLinkedin,
   faTelegram, faWhatsapp, faYoutube } from "@fortawesome/free-brands-svg-icons";
import { faEnvelope, faLink,
   faLocationDot, faPhone } from "@fortawesome/free-solid-svg-icons";
      ...
      <div className="flex gap-2 justify-center mt-4 pb-4">
        {Object.keys(page.buttons).map(buttonKey => (
            <Link 
                ...
                text-blue-950 p-2 flex justify-center items-center">
        ...
        {page.links.map(link => (
            <Link 
                ...
                <div className="relative -left-4 overflow-hidden w-16">
                    <div className="w-16 h-16 bg-blue-700 relative 
                ...
                <div className="flex-row justify-center shrink grow-0 overflow-hidden items-center">
                    <div>
                    <h3>{link.title}</h3>
